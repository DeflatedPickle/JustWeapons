...
public class ItemWarhammer extends Item implements IReach {
    private final float attackDamage;
    private final double attackSpeed;
    private final Item.ToolMaterial material;

    public ItemWarhammer(Item.ToolMaterial material, String unlocalized, String registry){
        this.material = material;
        this.maxStackSize = 1;
        this.setMaxDamage(material.getMaxUses() + (material.getMaxUses()));
        this.setCreativeTab(CreativeTabs.COMBAT);
        this.attackDamage = 9.0F + material.getDamageVsEntity();
        this.attackSpeed = -3.7F;
